...
Figura 1.4 Painel principal do LiteIDE
...
2. Para instalar o GoSublime, SidebarEnhancements e Go Build, pressione `Ctrl+Shift+p` para abrir o Package Control e então digite `pcip` (um atalho para "Package Control: Install Package").
	...
	Figura 1.8 Instalando pacotes no Sublime
...
Figura 1.8 Auto-complete inteligente para Go no Vim
...
Figura 1.10 Painel principal do Emacs para editor Go
...
Figura 1.1 Painel principal do Eclipse para Go
...
6. Verifique a instalação
	...
	Figura 1.15 Criar novo projeto e arquivo hello.go
	...
	Figura 1.16 Teste de um programa Go no Eclipse
